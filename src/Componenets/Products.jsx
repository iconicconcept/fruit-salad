...
function Products() {
  ...
  return (
    <section className="about-sec h-[max-content] bg-white text-[#828282] px-5 md:px-35 lg:px-35 flex justify-center items-center flex-col py-13">
        <p className="mb-3">MENU YANG MEMBUATMU JATUH CINTA</p>
        <h1 className="text-[#575757] font-semibold text-[27px] leading-9 text-center" >ENJOY THE BEST MENU AND GET <br /> 
