  ...
  return (
    <section className="Review-sec h-[max-content] bg-[#FFF0DC] text-[#828282] pl-5 px-5 md:pl-35 lg:pl-35 flex flex-col md:flex-row lg:flex-row gap-17 md:gap-10 lg:gap-10 py-20 overflow-x-hidden">
        <div className="md:w-85 lg:w-85 flex flex-col justify-between h-70 fromButtom">
            <h1 className="text-[#575757] font-semibold text-[32px] max-w-100 leading-9">What Are People 
            Saying <span className="text-[#FB9333]">About Us</span></h1>
            <p className="leading-5 text-[14px]">We are very happy if you are satisfied with our service and products, let's read pure reviews from customers who bought our products.</p>
            <h3 className="text-[27px] font-bold text-black" >02 <span className="text-[#828282] text-[12px] font-medium">/ 05</span></h3>
        ...
        <div className="flex flex-col md:flex-row lg:flex-row gap-10 md:gap-5 lg:gap-5 w-[100%] md:w-170 lg:w-170 h-[max-content] md:h-80 lg:h-80">
            <div  className="h-[max-content] w-[100%] md:w-55 lg:w-55 flex flex-col gap-4 py-5 px-5 text-[15px] bg-white relative pt-17 rounded">
